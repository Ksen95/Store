        ...
        if(!ot.isEmpty() & !Do.isEmpty()) {
            ...
            if (!price.isEmpty()) {
                ...
                if (price.equals("sorted_by_ascending_price")) {
                    ...
                    if (!category.isEmpty()) {
                        // Если категория равная samsung
                        if (category.equals("samsung")) {
                            ...
                            // Если категория равная бытовой xiaomi
                        } else if (category.equals("xiaomi")) {
                            ...
                            // Если категория равная apple
                        } else if (category.equals("apple")) {
                        ...
                        // Если категория равная HUAWEI
                        else if (category.equals("HUAWEI")) {
